...
FPONESN    EQU       $80000041           FLOATING ONE
...
FFPCOSH  MOVE.L    D6,-(SP)  SAVE OUR ONE WORK REGISTER
         ...
         MOVE.L    #FPONESN,D7 LOAD FLOATING POINT ONE
...
FFPTANH  MOVE.L    D6,-(SP)  SAVE OUR ONE WORK REGISTER
         ...
         MOVE.L    D7,-(SP)  SAVE RESULT
         MOVE.L    #FPONESN,D6 LOAD FLOATING POINT ONE
...
FFPTOVF2 MOVE.L    #FPONESN,D7 RETURN +1 AS RESULT
         BRA.S     FFPTRTN
